 ...
 * <code>com.corporate.knowledge.test.service.impl.CandidateLocalServiceImpl</code> and
...
public class CandidateLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.corporate.knowledge.test.service.impl.CandidateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static com.corporate.knowledge.test.model.Candidate addCandidate(
		com.corporate.knowledge.test.model.Candidate candidate) {

		return getService().addCandidate(candidate);
	}

	public static void crearCandidato(String company, String name) {
		getService().crearCandidato(company, name);
	}
	 ...
	 */
	public static com.corporate.knowledge.test.model.Candidate createCandidate(
		long candidateId) {
	 ...
	 */
	public static com.corporate.knowledge.test.model.Candidate deleteCandidate(
		com.corporate.knowledge.test.model.Candidate candidate) {
	...
	public static com.corporate.knowledge.test.model.Candidate fetchCandidate(
		long candidateId) {
	...
	public static java.util.List<com.corporate.knowledge.test.model.Candidate>
		getAllCandidatesOrdered() {

		return getService().getAllCandidatesOrdered();
	}
	 ...
	 * @throws PortalException if a candidate with the primary key could not be found
	 */
	public static com.corporate.knowledge.test.model.Candidate getCandidate(
			long candidateId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static com.corporate.knowledge.test.model.Candidate updateCandidate(
		com.corporate.knowledge.test.model.Candidate candidate) {

		return getService().updateCandidate(candidate);
	}

	public static boolean updateCandidateById(long candidateId, String name) {
		return getService().updateCandidateById(candidateId, name);
	}
	...
	private static ServiceTracker<CandidateLocalService, CandidateLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(CandidateLocalService.class);

		ServiceTracker<CandidateLocalService, CandidateLocalService>
			serviceTracker =
				new ServiceTracker
					<CandidateLocalService, CandidateLocalService>(
						bundle.getBundleContext(), CandidateLocalService.class,
						null);
