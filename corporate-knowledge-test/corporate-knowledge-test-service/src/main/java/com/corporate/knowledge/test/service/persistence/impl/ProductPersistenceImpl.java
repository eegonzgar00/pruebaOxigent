...
import com.corporate.knowledge.test.model.impl.ProductImpl;
import com.corporate.knowledge.test.model.impl.ProductModelImpl;
...
public class ProductPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.corporate.knowledge.test.model.Product"),
			true);
	}
