...
import com.corporate.knowledge.test.service.ProductoLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.corporate.knowledge.test.service.impl.ProductoLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.corporate.knowledge.test.service.impl.ProductoLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class ProductoLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ProductoLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductoLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.corporate.knowledge.test.service.ProductoLocalServiceUtil</code>.
	 */
	...
	public Producto createProducto(long productId) {
		return productoPersistence.create(productId);
	}
	...
	public Producto deleteProducto(long productId) throws PortalException {
		return productoPersistence.remove(productId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Producto.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return productoPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return productoPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Producto fetchProducto(long productId) {
		return productoPersistence.fetchByPrimaryKey(productId);
	}
	...
	public Producto getProducto(long productId) throws PortalException {
		return productoPersistence.findByPrimaryKey(productId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(productoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Producto.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Producto.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return productoLocalService.deleteProducto((Producto)persistedModel);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductoLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		productoLocalService = (ProductoLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductoLocalService.class.getName();
	}
